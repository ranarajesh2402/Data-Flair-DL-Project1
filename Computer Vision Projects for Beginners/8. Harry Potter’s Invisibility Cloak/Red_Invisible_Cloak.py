...
# If user want to quit the program they can press 'q' key and it will close the program. 

# Code Reference: https://www.analyticsvidhya.com/blog/2021/07/harry-potters-invisible-cloak-using-opencv-python/