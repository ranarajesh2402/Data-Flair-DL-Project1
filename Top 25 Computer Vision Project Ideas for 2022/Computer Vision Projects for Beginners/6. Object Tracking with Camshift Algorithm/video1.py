...
# Run the command below in terminal to test the video.
# python video1.py slow_traffic_small.mp4

# Code Reference : https://docs.opencv.org/4.x/d7/d00/tutorial_meanshift.html