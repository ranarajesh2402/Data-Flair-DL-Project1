...
# Run the command below in the terminal to test the script.
 
# python Collage_Mosaic_Generator.py  --target-image target.jpg  --input-folder Car_Images/  --grid-size 128 128

#                                     OR

# python Collage_Mosaic_Generator.py  --target-image target.jpg  --input-folder Car_Images/  --grid-size 128 128  --output-file mosaic2.png


# Reference- https://www.geeksforgeeks.org/implementing-photomosaics/
