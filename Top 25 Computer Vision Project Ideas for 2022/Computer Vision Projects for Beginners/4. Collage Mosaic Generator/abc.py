...
# python abc.py  --target-image a.jpg  --input-folder Car_Images/  --grid-size 128 128

#                                     OR

# python abc.py  --target-image a.jpg  --input-folder Car_Images/  --grid-size 128 128  --output-file mosaic2.png