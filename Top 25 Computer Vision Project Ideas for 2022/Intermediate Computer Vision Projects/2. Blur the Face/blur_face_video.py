...
# Run the following commands one after another in terminal to display the output webcam video:
# python blur_face_video.py --face face_detector --method simple
# python blur_face_video.py --face face_detector --method pixelated
# python blur_face_video.py --face face_detector --method pixelated --blocks 10
