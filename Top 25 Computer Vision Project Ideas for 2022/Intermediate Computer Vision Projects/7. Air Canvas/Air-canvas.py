...
# Note -> Only Green Color is working for now according to the code.

# Code Reference: https://techvidvan.com/tutorials/create-air-canvas-using-opencv-python/
#                 https://techvidvan.s3.amazonaws.com/machine-learning-projects/air-canvas-opencv-python-code.zip
