...
# NOTE: The beats will only work with 'GREEN' color. 
# 		If you want to detect other colors, change the values of 'greenLower' and 'greenUpper'.	


# CODE REFERENCE: https://towardsdatascience.com/virtual-drum-set-using-opencv-ebcb1553c778
#				  https://github.com/navendu-pottekkat/virtual-drums